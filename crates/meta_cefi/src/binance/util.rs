...
fn sign_hmac(payload: &str, key: &str) -> std::result::Result<String, InvalidLength> {
...
fn sign_rsa(
    ...
    key: &str,
    password: Option<&str>,
) -> std::result::Result<String, InvalidLength> {
...
mod tests {
    ...
    fn test_get_subscription() {
        assert_eq!(get_binance_symbol(Asset::ARB, Asset::USDT), "ARBUSDT".to_string());
    }
    #[test]
